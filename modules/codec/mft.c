...
//DEFINE_GUID(MFAudioFormat_Dolby_AC3, 0xe06d802c, 0xdb46, 0x11cf, 0xb4, 0xd1, 0x00, 0x80, 0x5f, 0x6c, 0xbb, 0xea);			// sunqueen delete
/*
...
static int FindMFT(decoder_t *p_dec)
{
	...
	MFT_REGISTER_TYPE_INFO input_type = { 0 /* *p_sys->major_type, *p_sys->subtype */ };			// sunqueen modify
