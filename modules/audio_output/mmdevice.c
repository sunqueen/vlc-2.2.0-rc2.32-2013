...
static VOID /*WINAPI*/ (*InitializeConditionVariable)(PCONDITION_VARIABLE);			// sunqueen modify
static BOOL /*WINAPI*/ (*SleepConditionVariableCS)(PCONDITION_VARIABLE,			// sunqueen modify
                                               PCRITICAL_SECTION, DWORD);
static VOID /*WINAPI*/ (*WakeConditionVariable)(PCONDITION_VARIABLE);			// sunqueen modify
#define LOOKUP(s) \
