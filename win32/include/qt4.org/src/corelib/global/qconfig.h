...
#define QT_BUILD_KEY "windows win32 g++-4 no-pkg-config"
...
#if defined(QT_CODEC_PLUGINS) && defined(QT_NO_CODEC_PLUGINS)
# undef QT_CODEC_PLUGINS
#elif !defined(QT_CODEC_PLUGINS) && !defined(QT_NO_CODEC_PLUGINS)
